...
declare global {
  interface HTMLDcIconActionPlayElement
    extends Components.DcIconActionPlay,
      HTMLStencilElement {}
  var HTMLDcIconActionPlayElement: {
    prototype: HTMLDcIconActionPlayElement;
    new (): HTMLDcIconActionPlayElement;
  };
  interface HTMLDcTextFieldElement
    extends Components.DcTextField,
      HTMLStencilElement {}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      'dc-icon-action-play': LocalJSX.DcIconActionPlay &
        JSXBase.HTMLAttributes<HTMLDcIconActionPlayElement>;
      'dc-text-field': LocalJSX.DcTextField &
        JSXBase.HTMLAttributes<HTMLDcTextFieldElement>;
    }
  }
}
